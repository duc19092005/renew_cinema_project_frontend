      ...
      >
        ...
        <div className={`flex items-center justify-between p-6 border-b ${theme === 'dark' ? 'border-gray-800' : theme === 'web3' ? 'border-purple-500/30' : 'border-gray-200'
          ...
          <div className="flex items-center gap-3">
            <div className={`w-12 h-12 rounded-lg flex items-center justify-center ${theme === 'web3'
        ...
        <div className="p-6">
          ...
          <div className="space-y-4">
            <p className={`text-base ${theme === 'dark' ? 'text-gray-300' : theme === 'web3' ? 'text-purple-200' : 'text-gray-700'
              }`}>
              Are you sure you want to log out of the system?
            </p>
            <p className={`text-sm ${theme === 'dark' ? 'text-gray-400' : theme === 'web3' ? 'text-purple-300/70' : 'text-gray-500'
              }`}>
        ...
        {/* Footer */}
        <div className={`flex justify-end gap-3 p-6 border-t ${theme === 'dark' ? 'border-gray-800' : theme === 'web3' ? 'border-purple-500/30' : 'border-gray-200'
          }`}>
          <button
            onClick={onClose}
            disabled={loading}
