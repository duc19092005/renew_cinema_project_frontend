...
import { Calendar, Copy, Moon, Repeat, Save, Sun } from 'lucide-react';
                ...
                <div className="flex items-center gap-3">
                    ...
                    <div className="flex items-center bg-slate-100 dark:bg-slate-700 rounded-lg p-1">
                        <button
                            ...
                            className={`px-2.5 py-2 rounded-md transition-colors flex items-center gap-2 text-xs font-bold ${theme === 'light'
                        ...
                        <button
                            ...
                            className={`px-2.5 py-2 rounded-md transition-colors flex items-center gap-2 text-xs font-bold ${theme === 'dark'
                                ? 'bg-white dark:bg-slate-600 text-red-600 shadow-sm'
                                : 'text-slate-500 hover:text-slate-800 dark:hover:text-slate-200'
                                }`}
                            title="Dark mode"
