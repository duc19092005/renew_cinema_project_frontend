// src/features/theater/components/Sidebar.tsx
import React from 'react';
import { LayoutDashboard, Users, CalendarDays, XCircle, UserCircle, ArrowLeftRight, LogOut } from 'lucide-react';
      ...
      <aside className="surface-elevated" style={{
        ...
        <div style={{ padding: 'var(--space-6)', display: 'flex', alignItems: 'center', justifyContent: 'space-between', borderBottom: '1px solid var(--border)' }}>
          <div>
            ...
            <p className="text-muted" style={{ fontSize: '10px', letterSpacing: '0.3em', margin: 0 }}>{t('Theater Manager')}</p>
          </div>
